...
{/* Quick Links */}
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/#offers" className="hover:text-yellow-400 transition">Special Offers</Link></li>
            <li><Link to="/#testimonials" className="hover:text-yellow-400 transition">Testimonials</Link></li>
